...
namespace Infrastructure.Persistence.Providers.PostgreSql
{
    public class IdentityPostgreSqlDbContext : IdentityDbContext, IIdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyAllConfigurationsFromNameSpace("Infrastructure.Persistence.Providers.PostgreSql.Identity.Config");
