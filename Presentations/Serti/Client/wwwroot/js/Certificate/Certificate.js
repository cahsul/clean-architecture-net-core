...
function fabrik() {
  ...
  canvas.add(text);
  new fabric.Image.fromURL("assets/images/backgrounds/user_bg4.jpg", function (image) {
...
function SaveImage() {
  ...
  console.log(json);
  var imageqwe = canvaszzz.toDataURL("image/jpg"); // document.write('<img src="' + imageqwe + '"/>');
  //var img = canvas.toDataURL("image/png");

  window.open("data:application/pdf;base64," + imageqwe);
}

export { Gambar, SaveImage, fabrik };
